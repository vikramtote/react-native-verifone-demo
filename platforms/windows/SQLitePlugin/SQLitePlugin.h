...
{
    /*
    * VerifoneNative Plugin for React Native.
    *
    ...
    */
    ...
    REACT_MODULE(VerifoneNativeModule, L"VerifoneNative");
    struct VerifoneNativeModule : std::enable_shared_from_this<VerifoneNativeModule>
    {
    public:
