...
namespace VerifoneNativeModule
{
    void VerifoneNativeModule::Attach(
    ...
    void VerifoneNativeModule::Close(
    ...
    void VerifoneNativeModule::DeleteDB(
    ...
    void VerifoneNativeModule::EchoStringValue(
    ...
    void VerifoneNativeModule::ExecuteSqlBatch(
    ...
    void VerifoneNativeModule::Open(
    ...
    void VerifoneNativeModule::BindStatement(sqlite3_stmt* stmt_ptr, int argIndex, const JSValue& arg)
    {
        switch (arg.Type())
        {
    ...
    bool VerifoneNativeModule::CloseDatabaseIfOpen(const hstring& absoluteDbPath, std::map<hstring, sqlite3*>& openDBs)
    {
        if (openDBs.find(absoluteDbPath) != openDBs.end())
        {
            ...
            {
                std::string debugMessage = "VerifoneNativeModuleModule: Error closing database: " + to_string(absoluteDbPath) + "\n";
    ...
    IAsyncOperation<StorageFile> VerifoneNativeModule::CopyDbAsync(const StorageFile& srcDbFile, const hstring& destDbFileName)
    {
    ...
    bool VerifoneNativeModule::ExecuteQuery(sqlite3* dbHandle, const DBQuery& query, JSValue& result)
    {
    ...
    JSValue VerifoneNativeModule::ExtractColumn(sqlite3_stmt* stmt, int columnIndex)
    {
    ...
    JSValueObject VerifoneNativeModule::ExtractRow(sqlite3_stmt* stmt)
    {
        JSValueObject row{};
    ...
    IAsyncOperation<StorageFile> VerifoneNativeModule::ResolveAssetFile(const std::string& assetFilePath, const std::string& dbFileName)
    {
    ...
    hstring VerifoneNativeModule::ResolveDbFilePath(const hstring dbFileName)
    {
